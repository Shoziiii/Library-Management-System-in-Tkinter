...
class menu:
    def __init__(self):
        ...
        conn.execute('CREATE TABLE if not exists book_info (title text not null, author text not null, year integer, isbn text)')
        conn.commit()
        conn.execute('CREATE TABLE if not exists book_issued (isbn text, student_id text, ISSUE_DATE DATE NOT NULL, RETURN_DATE DATE NOT NULL, PRIMARY KEY (isbn,student_id))')
        conn.commit()
        conn.close()
        self.a_1 = Canvas(self.root,bg = "#FFFFE4").place(x = 200,y = 25, width = 400,height = 450 )
        label_0 = Label(self.a_1,bg = "#FFFFE4",text = 'Library Management\n System',fg="#815B3A",font=("Georgia 13 bold",25,"bold")).place(x = 230,y = 65)
        l1=Button(self.a_1,text='BOOK DATA',relief = "groove",bg="#FFBA7A",font=("Georgia 13 bold",14),command=self.book).place(x=300,y=250,width=200,height=40)
        l2=Button(self.a_1,text='STUDENT DATA',relief = "groove",bg="#FFBA7A",font=("Georgia 13 bold",14),command=self.student).place(x=300,y=300,width=200,height=40)
        self.root.mainloop()
    def book(self):
        self.a_2 = Canvas(self.root,bg = "#FFBA7A").place(x = 0,y = 0, width = 800,height = 500 )
        l1=Button(self.a_2,text='Add Books',relief = "groove",bg="#FFFFE4",font=("Georgia 13 bold",14),command=self.addbook).place(x=30,y=50,width=200,height=40)
        l2=Button(self.a_2,text='Search Books',relief = "groove",bg="#FFFFE4",font=("Georgia 13 bold",14),command=self.search).place(x=30,y=170,width=200,height=40)

        l4=Button(self.a_2,text='All Books',relief = "groove",bg="#FFFFE4",font=("Georgia 13 bold",14),command=self.all).place(x=30,y=290,width=200,height=40)
        l4=Button(self.a_2,text='<< Main Menu',relief = "groove",bg="#FFFFE4",font=("Georgia 13 bold",14),command=self.mainmenu).place(x=30,y=410,width=200,height=40)
    def addbook(self):
        self.ayear=IntVar()
        ...
        e2=Entry(self.f1,width=45,bg='#FFBA7A',fg='black',textvariable=self.aauthor).place(x=150,y=100,height = 30)
        ...
        b1=Button(self.f1,text='Add',relief = "groove",bg="#FFBA7A",font=("Georgia 13 bold",14),command=self.adddata).place(x=66,y=300,width=150,height=40)
        b2=Button(self.f1,text='Back',relief = "groove",bg="#FFBA7A",font=("Georgia 13 bold",14),command=self.rm).place(x=284,y = 300,width=150,height=40)
    ...
    def search(self):
        ...
        b1=Button(self.f1,text='Search',relief = "groove",bg="#FFBA7A",font=("Georgia 13 bold",14),command=self.serch1).place(x=66,y=300,width=150,height=40)
        b1=Button(self.f1,text='Back',relief = "groove",bg="#FFBA7A",font=("Georgia 13 bold",14),command=self.rm).place(x=284,y = 300,width=150,height=40)
    ...
    def serch1(self):
        ...
        if k!="":
            ...
            if len(a)!=0:
                ...
                b1=Button(self.f1,text='Delete',relief = "groove",bg="#FFBA7A",font=("Georgia 13 bold",14),command=self.deleteitem).place(x=70,y=350,width=150,height=40)
                b2=Button(self.f1,text='Update',relief = "groove",bg="#FFBA7A",font=("Georgia 13 bold",14),command=self.updateitem).place(x=275,y=350,width=150,height=40)
            else:
    ...
    def updateitem(self):
        ...
        l2=Label(self.f1,text='Author : ',font=("Georgia 13 bold",14),bg="#FFFFE4").place(x=50,y=100,width = 100)
        e2=Entry(self.f1,width=45,bg='#FFBA7A',fg='black',textvariable=self.uauthor).place(x=150,y=100,height = 30)
        l3=Label(self.f1,text='Year : ',font=("Georgia 13 bold",14),bg="#FFFFE4").place(x=50,y=150,width = 100)
        ...
        self.f1.grid_propagate(0)
        b1=Button(self.f1,text='Update',relief = "groove",bg="#FFBA7A",font=("Georgia 13 bold",14),command=self.update).place(x=175,y=300,width=150,height=40)
    ...
    def student(self):
        ...
        l1=Button(self.a_3,text='Issue book',relief = "groove",bg="#FFFFE4",font=("Georgia 13 bold",14),command=self.issue).place(x=30,y=50,width=200,height=40)
        l2=Button(self.a_3,text='Return Book',relief = "groove",bg="#FFFFE4",font=("Georgia 13 bold",14),command=self.returnn).place(x=30,y=170,width=200,height=40)
        l3=Button(self.a_3,text='Student Activity',relief = "groove",bg="#FFFFE4",font=("Georgia 13 bold",14),command=self.activity).place(x=30,y=290,width=200,height=40)
        l4=Button(self.a_3,text='<< Main Menu',relief = "groove",bg="#FFFFE4",font=("Georgia 13 bold",14),command=self.mainmenu).place(x=30,y=410,width=200,height=40)
    ...
    def issue(self):
        ...
        l2=Label(self.f1,text='Student Id : ',font=("Georgia 13 bold",14),bg="#FFFFE4").place(x=50,y=100,width = 100)
        e2=Entry(self.f1,width=45,bg='#FFBA7A',textvariable=self.astudentt).place(x=150,y=100,height = 30)
        b1=Button(self.f1,text='Back',relief = "groove",bg="#FFBA7A",font=("Georgia 13 bold",14),command=self.rm).place(x=66,y=300,width=150,height=40)
        b1=Button(self.f1,text='Issue',relief = "groove",bg="#FFBA7A",font=("Georgia 13 bold",14),command=self.issuedbook).place(x=284,y = 300,width=150,height=40)
            ...
            if an!=[]:
                for i in an:
                    if int(i[0].replace("-",""))>0:
                        try:
                            conn.execute("INSERT INTO book_issued VALUES (?,?,date('now'),date('now','+7 day'))",(bookid,studentid,));
                            conn.commit()
                            conn.close()
    ...
    def returnn(self):
        ...
        e2=Entry(self.f1,width=45,bg='#FFBA7A',textvariable=self.astudentt).place(x=150,y=100,height = 30)
        b1=Button(self.f1,text='Back',relief = "groove",bg="#FFBA7A",font=("Georgia 13 bold",14),command=self.rm).place(x=66,y=300,width=150,height=40)
        b1=Button(self.f1,text='Return',relief = "groove",bg="#FFBA7A",font=("Georgia 13 bold",14),command=self.returnbook).place(x=284,y = 300,width=150,height=40)
        self.f1.grid_propagate(0)
    ...
    def activity(self):
        ...
        b1=Button(self.f1,text='Back',relief = "groove",bg="#FFBA7A",font=("Georgia 13 bold",14),command=self.rm).place(x=30,y=350,width=120,height=40)
        b1=Button(self.f1,text='Search',relief = "groove",bg="#FFBA7A",font=("Georgia 13 bold",14),command=self.searchact).place(x=180,y=350,width=120,height=40)
        b1=Button(self.f1,text='All',relief = "groove",bg="#FFBA7A",font=("Georgia 13 bold",14),command=self.searchall).place(x=330,y=350,width=120,height=40)
        self.f1.grid_propagate(0)
